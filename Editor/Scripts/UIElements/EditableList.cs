...
namespace EasyBezier
{
    ...
    {
        public static readonly string UssClassName = "eb-list";
        ...
        public static readonly string ImageButtonUssClassName = "eb-image-button";

        public event Action<EditableList, int> OnAddCallback;
        public event Action<EditableList, int> OnRemoveCallback;

        public SerializedProperty ArrayProperty { get => m_ArrayProperty; }
        public bool CanAdd { get => m_AddButton.enabledSelf; set => m_AddButton.SetEnabled(value); }
        ...
        public EditableList(SerializedProperty in_Array, Func<EditableList, int, VisualElement> in_MakeItem, bool in_CanDrag = true) : this(in_Array.displayName, in_Array, in_MakeItem, in_CanDrag) { }
